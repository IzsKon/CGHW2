...
int main(void)
{
	...
	bool is_per_vertex = false;
	glm::vec3 light_pos = { -2.2, 2.2, 2.2 };
    glm::vec3 eye_pos = { 0, 0, 10 };
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        auto vp =  glm::perspective(45/180.0f*3.1415926f, 1024.0f/768.0f, 0.1f, 10000.0f)*
            glm::lookAt(eye_pos, glm::vec3{0, 0, 0}, glm::vec3{0, 1, 0});
        prog["vp"] = vp;
        prog["vp2"] = glm::lookAt(eye_pos, glm::vec3{0, 0, 0}, glm::vec3{0, 1, 0});
        prog["view"] = glm::lookAt(eye_pos, glm::vec3{0, 0, 0}, glm::vec3{0, 1, 0});
		...
		else if (per_vertex == false && is_per_vertex == true) {
			is_per_vertex = false;
			prog = Program::LoadFromFile(
				"../resource/vs.vert",
				"../resource/gs.geom",
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            ImGui::SliderFloat3("Camera", glm::value_ptr(eye_pos), -10, 10);
            ImGui::SameLine();
